      ...
      array.push(
        <div className="flex flex-row gap-5" key={index}>
          ...
          <div className='flex flex-row w-3/4 items-center'>
            ...
            <button onClick={()=>chooseHandler(data.category)} className='w-1/4 mr-5 p-2 rounded-md  flex flex-row justify-center items-center border border-blue-400 hover:bg-blue-400'>Choose</button>
          </div>
        </div>,
      )
    })
